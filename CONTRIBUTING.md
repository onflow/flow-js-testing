...
- [Good first issues](https://github.com/onflow/flow-js-testing/labels/good%20first%20issue):
  issues which should only require a few lines of code, and a test or two.
- [Help wanted issues](https://github.com/onflow/flow-js-testing/labels/help%20wanted):
...
We try to follow the coding guidelines:

- Code should pass the linter: `npm run lint`
